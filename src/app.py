...
activities = {
    ...
    "Debate Team": {
        "description": "Build public speaking skills and compete in academic debates",
    ...
    "School Band": {
        "description": "Practice musical performance and play at school events",
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # Remove all matching entries so existing duplicates are cleaned up as well
